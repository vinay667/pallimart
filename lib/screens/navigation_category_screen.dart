...
class NCategoryScreen extends StatefulWidget {
  @override
  _NCategoryScreenState createState() => _NCategoryScreenState();
}

class _NCategoryScreenState extends State<NCategoryScreen> {
