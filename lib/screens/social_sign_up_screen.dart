...
class SocialSignUpScreen extends StatefulWidget
{
  ...
  SocialSignUpScreen(this.name,this.email);
  SignUpScreenState createState()=>SignUpScreenState(name,email);
}
class SignUpScreenState extends State<SocialSignUpScreen> {
  final String name,email;
  SignUpScreenState(this.name,this.email);
